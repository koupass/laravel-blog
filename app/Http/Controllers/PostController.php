...
//        $categories=Post::find($post_id);
    ...
    {
        if (str_word_count($text, 0) > $words_count) {// this word_count is character
            $words = str_word_count($text, 2);// this word_count is an array of the words
